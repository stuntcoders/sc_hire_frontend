...
export default function Search() {
  return (
    <>
      <div className="mb-4">
        <label htmlFor="email" className="block ml-1 text-sm font-medium text-gray-700 dark:text-white">
          Search Candidates
        </label>
      ...
      <section className="relative bg-white dark:bg-gray-800 shadow-lg overflow-hidden border-gray-900 rounded z-10">
        <ul className="dark:bg-gray-700 divide-y divide-gray-100 dark:divide-gray-600 rounded">
          {users.map(user => {
